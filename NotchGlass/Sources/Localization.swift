...
enum Strings {
    ...
    static let en: [String: String] = [
        ...
        "claudecode.status.hint.install": "Install Claude Code and sign in by running `claude` in Terminal, then reopen Settings.",
        ...
        "appearance.liveActivity.hint": "While work runs in the background — an agent task or a detached Ask — the collapsed notch shows the current step and elapsed time.",
        "network.proxy": "Proxy",
        "network.proxy.hint": "The proxy Notch connects through — AI requests and the Claude / Codex CLIs alike. Leave empty to follow the system proxy (agents also check your login shell).",
    ...
    static let zhHans: [String: String] = [
        ...
        "claudecode.status.hint.install": "安装 Claude Code 并在终端运行 `claude` 登录，然后重新打开设置。",
        ...
        "appearance.liveActivity.hint": "后台有任务在跑（Agent 任务或后台 Ask）时，收起的刘海显示当前动作和计时。",
        "network.proxy": "代理",
        "network.proxy.hint": "Notch 走的代理——AI 请求和 Claude / Codex CLI 都适用。留空则跟随系统代理（Agent 还会退到登录 Shell 里的设置）。",
        "network.proxy.placeholder": "http://127.0.0.1:7890",
    ...
    static let zhHant: [String: String] = [
        ...
        "claudecode.status.hint.install": "安裝 Claude Code 並在終端機執行 `claude` 登入，然後重新開啟設定。",
        ...
        "appearance.liveActivity.hint": "背景有任務在跑（Agent 任務或背景 Ask）時，收起的瀏海顯示目前動作與計時。",
        "network.proxy": "代理",
        "network.proxy.hint": "Notch 走的代理——AI 請求和 Claude / Codex CLI 都適用。留空則跟隨系統代理（Agent 還會退到登入 Shell 裡的設定）。",
        "network.proxy.placeholder": "http://127.0.0.1:7890",
