...
enum Strings {
    ...
    static let zhHans: [String: String] = [
        ...
        "model.keenableHint": "一个面向所有模型的搜索后端。获取密钥 ",
        "model.keenableHint.host": "keenable.ai",
        "model.exaApiKey": "Exa 密钥",
        "model.exaPasteKey": "粘贴你的 Exa API 密钥",
        "model.exaHint": "带全文支撑的搜索后端。获取密钥 ",
        "model.exaHint.host": "exa.ai",
        "model.test": "测试",
        "model.cancel": "取消",
        "model.change": "更改",
        ...
        "agent.placeholder": "描述交给 Agent 的任务…",
        ...
        "agent.interrupted": "任务中断 —— 运行期间 Notch 已退出",
        "agent.interrupted.resume": "继续这个会话：%@",
        "agent.resume": "用 %@ 继续会话",
        "agent.cancel": "取消任务",
        "agent.cancelConfirm": "确认取消？",
        "agent.openFolder": "打开文件夹",
        "agent.openResult": "查看结果",
        "agent.dismiss": "关闭",
        "agent.filesChanged": "改动了 %lld 个文件",
        "agent.detail": "详情",
        "agent.detail.empty": "还没有活动记录",
        ...
        "claudecode.status.hint.ready": "Notch 调用你本地的 Claude Code CLI——用量计入你的 Claude 订阅。",
        "claudecode.status.hint.login": "已安装 Claude Code。请在终端运行 `claude` 完成登录后，重新打开此处。",
        "claudecode.status.hint.install": "安装 Claude Code 并运行 `claude` 登录，然后重新打开设置。",
        ...
        "grok.status.hint.ready": "Notch 会调用本机的 Grok CLI，用量计入你的 xAI 套餐。",
        "grok.status.hint.login": "已安装 Grok CLI。用 `grok login` 登录（或设置 XAI_API_KEY），然后重新打开此处。",
        "grok.status.hint.install": "安装 Grok CLI 并运行 `grok login`，然后重新打开设置。",
        ...
        "grok.error.sessionFailed": "Grok 无法创建会话——通常是 Grok CLI 需要更新。请在终端运行 `grok update` 后重试。",
        ...
        "general.fullscreenAutoHide.hint": "有应用全屏占据屏幕时，把小岛收起来。仅影响外接显示器。",
        "appearance.liveActivity": "实时活动",
        "appearance.liveActivity.hint": "后台有任务在跑时，收起的刘海显示当前动作和计时。",
        "network.proxy": "代理",
        "network.proxy.hint": "AI 请求和 Claude / Codex CLI 都走这个代理。留空则跟随系统代理。",
        "network.proxy.placeholder": "http://127.0.0.1:7890",
        "network.proxy.status.manual": "全 App 与 Agent 走 %@",
        "network.proxy.status.inherited": "自动：Agent 继承自环境变量 — %@",
        "network.proxy.status.system": "自动：系统代理 — %@",
        "network.proxy.status.shell": "自动：Agent 走登录 Shell 代理 — %@",
        "network.proxy.status.none": "自动：没找到代理，直连",
        ...
        "result.followUp.agent": "向聊天模型追问这次任务…",
    ...
    static let zhHant: [String: String] = [
        ...
        "model.keenableHint": "一個面向所有模型的搜尋後端。取得金鑰 ",
        "model.keenableHint.host": "keenable.ai",
        "model.exaApiKey": "Exa 金鑰",
        "model.exaPasteKey": "貼上你的 Exa API 金鑰",
        "model.exaHint": "帶全文支撐的搜尋後端。取得金鑰 ",
        "model.exaHint.host": "exa.ai",
        "model.test": "測試",
        "model.cancel": "取消",
        "model.change": "更改",
        ...
        "agent.placeholder": "描述交給 Agent 的任務…",
        ...
        "agent.interrupted": "任務中斷 —— 執行期間 Notch 已退出",
        "agent.interrupted.resume": "繼續這個工作階段：%@",
        "agent.resume": "用 %@ 繼續工作階段",
        "agent.cancel": "取消任務",
        "agent.cancelConfirm": "確認取消？",
        "agent.openFolder": "打開資料夾",
        "agent.openResult": "查看結果",
        "agent.dismiss": "關閉",
        "agent.filesChanged": "改動了 %lld 個檔案",
        "agent.detail": "詳情",
        "agent.detail.empty": "還沒有活動記錄",
        "agent.detail.model": "模型 · %@",
        "agent.detail.context": "上下文 · %@",
        ...
        "claudecode.status.hint.ready": "Notch 呼叫你本機的 Claude Code CLI——用量計入你的 Claude 訂閱。",
        "claudecode.status.hint.login": "已安裝 Claude Code。請在終端機執行 `claude` 完成登入後，重新開啟此處。",
        "claudecode.status.hint.install": "安裝 Claude Code 並執行 `claude` 登入，然後重新開啟設定。",
        ...
        "grok.status.hint.ready": "Notch 會呼叫本機的 Grok CLI，用量計入你的 xAI 方案。",
        "grok.status.hint.login": "已安裝 Grok CLI。用 `grok login` 登入（或設定 XAI_API_KEY），然後重新開啟此處。",
        "grok.status.hint.install": "安裝 Grok CLI 並執行 `grok login`，然後重新開啟設定。",
        ...
        "grok.error.sessionFailed": "Grok 無法建立工作階段——通常是 Grok CLI 需要更新。請在終端機執行 `grok update` 後重試。",
        ...
        "general.fullscreenAutoHide.hint": "有應用全螢幕佔據螢幕時，把小島收起來。僅影響外接螢幕。",
        "appearance.liveActivity": "即時動態",
        "appearance.liveActivity.hint": "背景有任務在跑時，收起的瀏海顯示目前動作與計時。",
        "network.proxy": "代理",
        "network.proxy.hint": "AI 請求和 Claude / Codex CLI 都走這個代理。留空則跟隨系統代理。",
        "network.proxy.placeholder": "http://127.0.0.1:7890",
        "network.proxy.status.manual": "全 App 與 Agent 走 %@",
        "network.proxy.status.inherited": "自動：Agent 繼承自環境變數 — %@",
        "network.proxy.status.system": "自動：系統代理 — %@",
        "network.proxy.status.shell": "自動：Agent 走登入 Shell 代理 — %@",
        "network.proxy.status.none": "自動：沒找到代理，直連",
        ...
        "result.followUp.agent": "向聊天模型追問這次任務…",
